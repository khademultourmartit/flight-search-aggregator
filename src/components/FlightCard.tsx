...
export default function FlightCard({
  ...
  return (
    <Box className="flight-search-card">
          ...
          <Box py={1.5}>
            ...
            >
              ...
              <Grid item xs={6} sm={6} md={2}>
                ...
                >
                  <Typography className="search-flight-time">
                    {moment(flight?.departureTime, "HH:mm:ss").format("HH:mm")}
                  </Typography>
                ...
                <Box className="flight-timeline-wrapper">
                  <Box className="timeline-header">
                    <Typography className="timeline-date-left">
                      ...
                      >
                        {flight?.originCity} (
                        {moment(flight?.departureTime, "HH:mm:ss").format(
                          "HH:mm",
                        )}
                        )
                      </Typography>

                      {moment(flight?.departureTime).format("ddd, DD MMM")}
                    </Typography>
                    ...
                    <Typography className="timeline-date-right">
                      ...
                      >
                        ...
                        {moment(flight?.arrivalTime, "HH:mm:ss").format(
                          "HH:mm",
                        )}
                        )
                      </Typography>
                      {moment(flight?.arrivalTime).format("ddd, DD MMM")}
                    </Typography>
                  </Box>
                  ...
                  <Box className="flight-timeline-line">
                    ...
                    <span className="timeline-dot middle" />
              ...
              <Grid item xs={6} sm={6} md={2}>
                ...
                >
                  <Typography className="search-flight-time">
                    {moment(flight?.arrivalTime, "HH:mm:ss").format("HH:mm")}
                  </Typography>
                ...
                <Box>
                  <Stack direction="row" spacing={2} alignItems={"center"}>
                    <button className="flightSeat-btn">
                      <Image src={seat} alt="seat" width={16} height={16} />{" "}
                      <span>{flight?.seatsAvailable} Seat</span>
                    </button>
                  ...
                  <Stack direction="row" spacing={2} alignItems={"center"}>
                    ...
                    <button className="flight-BookHold-btn">
                      {flight?.instantTicketIssueRequired === false ? (
                        <span className="flight-BookHold">Book & Hold</span>
                      ) : (
